...
def upgrade() -> None:
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_vb_vehicle_time_critical
    ...
    op.execute("""
        CREATE UNIQUE INDEX IF NOT EXISTS idx_res_confirmation
          ON public.reservations (confirmation_number)
    """)

    # 3. Counter checkout + DNR check
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_customers_license_critical
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_res_customer_pickup
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_vehicles_class_location_status
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_payments_expiring_auths
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_claims_tenant_status_assigned
...
def downgrade() -> None:
    op.execute("DROP INDEX IF EXISTS public.idx_res_active")
    op.execute("DROP INDEX IF EXISTS public.idx_customers_fulltext")
    op.execute("DROP INDEX IF EXISTS audit.idx_audit_resource")
    op.execute("DROP INDEX IF EXISTS public.idx_claims_tenant_status_assigned")
    op.execute("DROP INDEX IF EXISTS public.idx_payments_expiring_auths")
    op.execute("DROP INDEX IF EXISTS public.idx_vehicles_class_location_status")
    op.execute("DROP INDEX IF EXISTS public.idx_res_customer_pickup")
    op.execute("DROP INDEX IF EXISTS public.idx_customers_license_critical")
    op.execute("DROP INDEX IF EXISTS public.idx_res_confirmation")
    op.execute("DROP INDEX IF EXISTS public.idx_vb_vehicle_time_critical")
